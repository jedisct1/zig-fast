...
pub fn build(b: *std.Build) void {
    ...
    // Cross-implementation validation executable
    const validate_exe = b.addExecutable(.{
        .name = "validate",
        .root_module = b.createModule(.{
            .root_source_file = b.path("tmp/test_interop.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "zig", .module = mod },
    ...
    // Step to run validation tests
    const validate_step = b.step("validate", "Run cross-implementation validation tests");
